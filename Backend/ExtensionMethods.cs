...
public static class ExtensionMethods
{
  ...
  public static void Log(this ControllerBase controller, object? msg = null, [CallerMemberName] string callerMethod = "")
  {
    lock (LockObject)
    {
  ...
  public static void Log(this Microsoft.AspNetCore.SignalR.Hub hub, object? msg = null, [CallerMemberName] string callerMethod = "")
  {
    //Note: Color output requires "launchBrowser": false in launchSettings.json
    Console.BackgroundColor = ConsoleColor.Gray;
    Console.ForegroundColor = ConsoleColor.Black;
