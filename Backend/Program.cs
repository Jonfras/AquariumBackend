...
string? connectionString = builder.Configuration.GetConnectionString("Aquarium")!;
...
Console.ResetColor();
builder.Services.AddDbContext<AquariumContext>(options => options.UseSqlite(connectionString));
#endregion
